...
<Image src="../../public/v6.png" width="300" height="100" />
### Example
...
<Image src="../../public/v7.png" width="600" height="400" />
...
- TLB的成功依賴於時間局部性(temporal locality)和空間局部性(spatial locality),只要某個程式表性出這種局部性,就考以獲得較高的命中率
...
2. 軟體
  - 使用RISC來處裡TLB Miss
    ...
    - 這個trap handler用來處理TLB miss,當他運行時會查找page table中的translation information,然後使用privileged instruction來更新TLB
